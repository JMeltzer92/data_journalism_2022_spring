...
mutate(
  jobs_retained_category = case_when(
    ...
    jobs_retained >= 10 & jobs_retained < 25 ~ '10_to_24',
    jobs_retained >= 25 & jobs_retained < 50 ~ '25_to_49',
    jobs_retained >= 50 & jobs_retained < 100 ~ '50_to_99',
    jobs_retained >= 100 & jobs_retained < 250 ~ '100_to_249',
    jobs_retained >= 250 & jobs_retained < 500 ~ '250_to_499',
    jobs_retained == 500 ~ '500'
  )
)
```
```{r}
maryland_jobs_categories %>% group_by(jobs_retained_category) %>% summarize(count=n()) %>% arrange(jobs_retained_category)
```
...
**Answer**
date_approved=<chr>, CleanDate=<dttm>
