...
**Answer**
the zip codes do not have matching data types - one is a character and one is a double (?)
```{r}
...
**Answer**
Number of Loans = 41968, Average = 55546.84, Median = 19949.00
```{r}
...
**Answer**
Number of Loans = 112056, Average Amount = 89194.67, Median Amount = 20833.00
```{r}
...
**Answer**
Rural areas with a majority non-Hispanic Black population got 145 loans, with the average amount being 44815.22, and a median amount of 19064.57. Urban centers got far more, with 41823 loans, and a higher average payout of 55584.05. The median was similar, however, at 19950.00.
```{r}
...
**Answer**
Non-hipsanic white rural areas received 18083 loans, averaging 74463.32 and a median amount of 20833. Urban areas received more with 93973, with an average of 92029.39. The median amount, however, was also 20833. This means that most white-owned businesses that received loans are sole proprietorships.
```{r}
